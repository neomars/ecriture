...
*   **Smart AI Chat Assistant**: Chat with a persistent writing companion in the right-hand sidebar. Uses the integrated `llama-cpp-python` engine with the **Gemma 4** model (`unsloth/gemma-2-2b-it-GGUF`) downloaded directly from Hugging Face.
