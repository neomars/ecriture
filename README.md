...
- **Signalement** : chaque texte généré par l'IA a un bouton **🚩 Signaler** pour rapporter un contenu offensant, dangereux, inapproprié ou faux, via GitHub ou, sans compte, par e-mail à ecriture.app@gmail.com (aussi accessible depuis « À propos »).
...
- **Reporting**: every piece of AI-generated text has a **🚩 Report** button to flag offensive, dangerous, inappropriate or false content, via GitHub or, with no account, by e-mail to ecriture.app@gmail.com (also available from "About").
