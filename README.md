...
*   **Contextual AI Writing Menu**: Select any text in the editor to bring up a floating smart caret menu. Use tools like *Describe*, *Rewrite* (with slang, elegant, medieval, poetic, brutal, and cynical style presets), *Expand*, *Show, Don't Tell* (to generate sensory variations of explanatory sentences), and *Sensory Detail Injector* (to ground abstract scenes with sights, sounds, and textures) with support for direct replacements, regeneration, and fine-tuning.
